...
CFLAGS += $(shell pkg-config --cflags dbus-1 libpulse libnl-3.0 libnl-genl-3.0 libnl-route-3.0)
LDFLAGS += $(shell pkg-config --libs dbus-1 libpulse libnl-3.0 libnl-genl-3.0 libnl-route-3.0)
